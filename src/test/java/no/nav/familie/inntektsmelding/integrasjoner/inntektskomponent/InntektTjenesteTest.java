...
class InntektTjenesteTest {
    ...
    private static final PersonInfo PERSON_INFO = new PersonInfo("Ola", "Kari","Nordmann", new PersonIdent("12345678901"), new AktørIdEntitet(AKTØR_ID), LocalDate.of(1990, 1, 1), "99887766", Kjønn.MANN);
    ...
    @BeforeEach
    void setUp() {
        tjeneste = new InntektTjeneste(klient, arbeidsforholdTjeneste);
    }
    ...
    void skal_teste_at_inntekter_innhentes_happy_case() {
        ...
        var forventetRequest = new FinnInntektRequest(PERSON_INFO.aktørId().getAktørId(), YearMonth.of(2024, 7), YearMonth.of(2024, 9));
        ...
        when(arbeidsforholdTjeneste.harJobbetHeleBeregningsperioden(any(), any(), any())).thenReturn(true);
    ...
    void skal_teste_at_inntekter_innhentes_dagens_dato_er_før_rapporteringsfrist_og_inntekt_ikke_finnes_for_siste_måned() {
        ...
        var forventetRequest = new FinnInntektRequest(PERSON_INFO.aktørId().getAktørId(), YearMonth.of(2024, 6), YearMonth.of(2024, 9));
    ...
    void skal_teste_at_inntekter_innhentes_dagens_dato_er_før_rapporteringsfrist_og_4_uker_før_stp() {
        ...
        var forventetRequest = new FinnInntektRequest(PERSON_INFO.aktørId().getAktørId(), YearMonth.of(2024, 7), YearMonth.of(2024, 11));
    ...
    void skal_fjerne_alle_eldre_måneder_uten_inntekt_når_tre_nyeste_er_rapportert() {
        ...
        var forventetRequest = new FinnInntektRequest(PERSON_INFO.aktørId().getAktørId(), YearMonth.of(2024, 8), YearMonth.of(2024, 11));
    ...
    void skal_teste_at_søker_ansatt_i_deler_av_beregningsperioden_får_snitt_fra_korrekte_måneder() {
        ...
        when(klient.finnInntekt(forventetRequest, YTELSETYPE)).thenReturn(response);
        when(arbeidsforholdTjeneste.harJobbetHeleBeregningsperioden(any(), any(), any())).thenReturn(false);
