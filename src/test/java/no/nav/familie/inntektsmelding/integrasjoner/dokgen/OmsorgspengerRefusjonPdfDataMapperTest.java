...
class OmsorgspengerRefusjonPdfDataMapperTest {
    ...
    void skal_opprette_pdfData() {
        ...
        var delvisFraværsDag = START_DATO.plusDays(5);
        var delvisFraværstimer = BigDecimal.valueOf(4);
        var trukketFraværsDag = START_DATO.plusDays(6);
        ...
        var omsorgspengerEntitet = OmsorgspengerEntitet.builder()
            ...
            .medDelvisFraværsPerioder(List.of(new DelvisFraværsPeriodeEntitet(delvisFraværsDag, delvisFraværstimer),
                new DelvisFraværsPeriodeEntitet(trukketFraværsDag, BigDecimal.ZERO)))
            .build();
        ...
        var pdfData = OmsorgspengerRefusjonPdfDataMapper.mapOmsorgspengerRefusjonData(inntektsmeldingEntitet, ARBEIDSGIVER_NAVN, personInfo, ARBEIDSGIVER_IDENT);
        ...
        assertThat(pdfData.getÅrForRefusjon()).isEqualTo(BigDecimal.valueOf(START_DATO.getYear()));
        ...
        assertThat(pdfData.getOmsorgspenger()).isNotNull();
        assertThat(pdfData.getOmsorgspenger().harUtbetaltPliktigeDager()).isTrue();
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder()).hasSize(1);
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder().getFirst().fom()).isEqualTo(FormatUtils.formaterDatoForLister(fraværsPeriode.getPeriode().getFom()));
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder().getFirst().tom()).isEqualTo(FormatUtils.formaterDatoForLister(fraværsPeriode.getPeriode().getTom()));
        assertThat(pdfData.getOmsorgspenger().delvisFraværsPerioder()).hasSize(1);
        assertThat(pdfData.getOmsorgspenger().delvisFraværsPerioder().getFirst().dato()).isEqualTo(FormatUtils.formaterDatoForLister(delvisFraværsDag));
        assertThat(pdfData.getOmsorgspenger().delvisFraværsPerioder().getFirst().timer()).isEqualTo(delvisFraværstimer);
        assertThat(pdfData.getOmsorgspenger().trukketFraværsPerioder()).hasSize(1);
        assertThat(pdfData.getOmsorgspenger().trukketFraværsPerioder().getFirst().dato()).isEqualTo(FormatUtils.formaterDatoForLister(trukketFraværsDag));
    }
    ...
    void skal_opprette_med_endringsårsaker() {
        ...
        assertThat(pdfData.getOmsorgspenger()).isNotNull();
        assertThat(pdfData.getOmsorgspenger().harUtbetaltPliktigeDager()).isTrue();
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder()).hasSize(2);
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder().get(0).fom()).isEqualTo(FormatUtils.formaterDatoForLister(fraværsPeriode1.getPeriode().getFom()));
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder().get(0).tom()).isEqualTo(FormatUtils.formaterDatoForLister(fraværsPeriode1.getPeriode().getTom()));
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder().get(1).fom()).isEqualTo(FormatUtils.formaterDatoForLister(fraværsPeriode2.getPeriode().getFom()));
        assertThat(pdfData.getOmsorgspenger().fraværsPerioder().get(1).tom()).isEqualTo(FormatUtils.formaterDatoForLister(fraværsPeriode2.getPeriode().getTom()));
        assertThat(pdfData.getOmsorgspenger().delvisFraværsPerioder()).hasSize(0);
        assertThat(pdfData.getOmsorgspenger().trukketFraværsPerioder()).hasSize(0);
