...
class ForespørselBehandlingTjenesteTest extends EntityManagerAwareTest {
    ...
    void skal_returnere_liste_av_inntektsmeldingdto_for_forespørsler() {
        ...
        var forespørsel1sak1 = ForespørselMapper.mapForespørsel(LocalDate.of(2025, 1, 1), Ytelsetype.PLEIEPENGER_SYKT_BARN, AKTØR_ID, BRREG_ORGNUMMER, SAK_ID, LocalDate.of(2025, 1, 1));
        var forespørsel1sak2 = ForespørselMapper.mapForespørsel(LocalDate.of(2025, 2, 1), Ytelsetype.PLEIEPENGER_SYKT_BARN, AKTØR_ID, BRREG_ORGNUMMER, SAK_ID_2 , LocalDate.of(2025, 2, 1));
        var forespørsel2sak1 = ForespørselMapper.mapForespørsel(LocalDate.of(2025, 3, 1), Ytelsetype.PLEIEPENGER_SYKT_BARN, AKTØR_ID, BRREG_ORGNUMMER, SAK_ID, LocalDate.of(2025, 3, 1));
        var forespørsel2sak2 = ForespørselMapper.mapForespørsel(LocalDate.of(2025, 4, 1), Ytelsetype.PLEIEPENGER_SYKT_BARN, AKTØR_ID, BRREG_ORGNUMMER, SAK_ID_2, LocalDate.of(2025, 4, 1));
