...
public class ForespørselMapper {
    ...
    public static ForespørselEntitet mapForespørsel(String orgnummer, LocalDate skjæringstidspunkt, String aktørId, Ytelsetype ytelsetype, String saksnummer, LocalDate førsteUttaksdato, List<PeriodeDto> etterspurtePerioder) {
        return ForespørselEntitet.builder()
            .medOrganisasjonsnummer(orgnummer)
            .medSkjæringstidspunkt(skjæringstidspunkt)
            .medAktørId(new AktørIdEntitet(aktørId))
