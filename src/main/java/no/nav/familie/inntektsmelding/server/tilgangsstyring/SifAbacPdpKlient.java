...
@ApplicationScoped
@RestClientConfig(tokenConfig = TokenFlow.ADAPTIVE, scopesProperty = "sif.abac.pdp.scope", scopesDefault = "api://prod-gcp.k9saksbehandling.sif-abac-pdp/.default", endpointDefault = "http://sif-abac-pdp/sif/sif-abac-pdp/api", endpointProperty = "sif.abac.pdp.url")
