...
@RestClientConfig(tokenConfig = TokenFlow.NO_AUTH_NEEDED, endpointProperty = "fpdokgen.url", endpointDefault = "http://fpdokgen.teamforeldrepenger")
public class FpDokgenKlient {
    ...
    public byte[] genererPdf(InntektsmeldingPdfData dokumentdata) {
        var templatePath = String.format("/template/%s/template_%s", "maltype", Språkkode.NB);
