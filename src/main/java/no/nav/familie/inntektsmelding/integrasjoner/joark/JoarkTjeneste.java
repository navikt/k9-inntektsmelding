...
public class JoarkTjeneste {
    ...
    private List<DokumentInfoOpprett> lagDokumenter(String xmlAvInntektsmelding) {
        ...
        var fysiskDokument = lesMockPdf();
        var dokumentPDF = new Dokumentvariant(Dokumentvariant.Variantformat.ARKIV, Dokumentvariant.Filtype.PDF, fysiskDokument); // TODO Her må vi sette inn PDF
    ...
    private byte[] lesMockPdf() {
        Path pdfPath = Paths.get("./src/main/resources/test.pdf");
        try {
