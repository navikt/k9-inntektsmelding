...
@ApplicationScoped
@ProsessTask(value = OpprettForespørselDialogportenTask.TASK_TYPE)
public class OpprettForespørselDialogportenTask implements ProsessTaskHandler {
    ...
    OpprettForespørselDialogportenTask() {
        // CDI
    }

    @Inject
    public OpprettForespørselDialogportenTask(DialogportenTjeneste dialogportenTjeneste, ForespørselBehandlingTjeneste forespørselBehandlingTjeneste) {
