...
public final class ProsessTaskFeilTabell implements BigQueryTabellDefinisjon {
    ...
    private static final String ENDELIG_FEILET_FOERSTE_GANG = "endelig_feilet_foerste_gang";
    ...
    public String getTabellNavn() {
        return "prosess_task_feil_log_v4";
    }
    ...
    public Schema getSchema() {
        return Schema.of(
            ...
            BigQueryTabellDefinisjon.newNullableField(ENDELIG_FEILET_FOERSTE_GANG, StandardSQLTypeName.TIMESTAMP),
    ...
    public Function<BigQueryRecord, Map<String, ?>> getRowMapper(Instant now) {
        return record -> {
            ...
            map.put(ENDELIG_FEILET_FOERSTE_GANG, r.endeligFeiletFørsteGangTid());
    ...
    // Viktig å sette hvis objektet skal senere brukes til å gjøre groupby
    @Override
