...
(
    ...
    BRUKER_AKTOER_ID VARCHAR(20) NOT NULL,
...
create index IDX_FORESPOERSEL_STP_ORGNR_BRUKER_YTELSE_SAKSNR on FORESPOERSEL (SKJAERINGSTIDSPUNKT, ORGNR, BRUKER_AKTOER_ID, YTELSE_TYPE);
