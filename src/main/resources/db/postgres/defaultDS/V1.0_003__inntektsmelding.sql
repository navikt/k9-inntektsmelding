...
create index IDX_INNTEKTSMELDING_START_DATO_ARBEIDSGIVER_IDENT_BRUKER_YTELSE_SAKSNR on INNTEKTSMELDING (START_DATO_PERMISJON, ARBEIDSGIVER_IDENT, BRUKER_AKTOER_ID, YTELSE_TYPE);
