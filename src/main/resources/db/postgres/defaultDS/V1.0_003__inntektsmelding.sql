...
create index IDX_INNTEKTSMELDING_START_DATO_ARBEIDSGIVER_IDENT_BRUKER_YTELSE_SAKSNR on INNTEKTSMELDING (START_DATO, ARBEIDSGIVER_IDENT, AKTOER_ID, YTELSE_TYPE);

comment on table INNTEKTSMELDING is 'En inntektsmelding fra en arbeidsgiver';
comment on column INNTEKTSMELDING.ID is 'PK';
comment on column INNTEKTSMELDING.START_DATO is 'Startdato for ytelsen';
