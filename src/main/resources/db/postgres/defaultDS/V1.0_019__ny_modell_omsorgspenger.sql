...
ALTER TABLE OMSORGSPENGER RENAME CONSTRAINT omsorgspenger_pkey TO pk_omsorgspenger;
ALTER TABLE FRAVAERS_PERIODE RENAME CONSTRAINT fravaers_periode_pkey TO pk_fravaers_periode;
ALTER TABLE DELVIS_FRAVAERS_PERIODE RENAME CONSTRAINT delvis_fravaers_periode_pkey TO pk_delvis_fravaers_periode;

-- Create indexes
CREATE INDEX idx_omsorgspenger_inntektsmelding_id ON OMSORGSPENGER(INNTEKTSMELDING_ID);
CREATE INDEX idx_fravaers_periode_omsorgspenger_id ON FRAVAERS_PERIODE(OMSORGSPENGER_ID);
CREATE INDEX idx_delvis_fravaers_periode_omsorgspenger_id ON DELVIS_FRAVAERS_PERIODE(OMSORGSPENGER_ID);
