...
CREATE TABLE DELVIS_FRAVAERS_DAG_FORESPOERSEL (
    ...
    FORVENTET_ARBEIDS_TIMER NUMERIC(5, 2) NOT NULL,
...
COMMENT ON COLUMN DELVIS_FRAVAERS_DAG_FORESPOERSEL.FORVENTET_ARBEIDS_TIMER IS 'Antall timer bruker vanligvis jobber';
